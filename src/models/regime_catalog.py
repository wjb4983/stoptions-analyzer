...
_LEG_MODEL_CATALOG: dict[str, tuple[ModelDescriptor, ...]] = {
    ...
    "regime_change_detection": (
        ...
        ModelDescriptor(
            model_name="policy_gradient_allocation",
            display_name="Policy Gradient Allocation",
            hyperparameter_template={"learning_rate": 0.0003, "entropy_coef": 0.02, "discount_factor": 0.99},
            capability_tags=frozenset({"supports_architecture_spec"}),
            catalog_phase="phase_2",
        ),
        ModelDescriptor(
            model_name="dqn_regime_allocation",
            display_name="DQN Regime Allocation",
            hyperparameter_template={"learning_rate": 0.0005, "target_update_interval": 25, "discount_factor": 0.98},
            capability_tags=frozenset({"supports_architecture_spec"}),
            catalog_phase="phase_2",
        ),
        ModelDescriptor(
            model_name="ppo_regime_policy",
            display_name="PPO Regime Policy",
            hyperparameter_template={"clip_ratio": 0.2, "epochs": 4, "gae_lambda": 0.95},
            capability_tags=frozenset({"supports_architecture_spec"}),
            catalog_phase="phase_2",
        ),
        ModelDescriptor(
    ...
    "cross_asset_macro_conditioned": (
        ...
        ModelDescriptor(
            model_name="temporal_transformer_regime",
            display_name="Temporal Transformer Regime",
            hyperparameter_template={"attention_heads": 4, "hidden_dim": 64, "dropout": 0.1},
            capability_tags=frozenset({"supports_architecture_spec"}),
            catalog_phase="phase_2",
        ),
        ModelDescriptor(
            model_name="tcn_regime",
            display_name="TCN Regime Model",
            hyperparameter_template={"channels": [16, 32], "kernel_size": 3, "dropout": 0.1},
            capability_tags=frozenset({"supports_architecture_spec"}),
            catalog_phase="phase_2",
        ),
        ModelDescriptor(
            model_name="lstm_regime",
            display_name="LSTM Regime Model",
            hyperparameter_template={"hidden_size": 32, "num_layers": 2, "dropout": 0.1},
            capability_tags=frozenset({"supports_architecture_spec"}),
            catalog_phase="phase_2",
        ),
        ModelDescriptor(
