...
from .paradigms import (
    ...
    MeanReversionModel,
    PPORegimePolicyModel,
    PolicyGradientAllocationModel,
    ...
    TCNRegimeModel,
    TemporalTransformerRegimeModel,
...
MODEL_REGISTRY: dict[str, type[ModelInterface]] = {
    ...
    PolicyGradientAllocationModel.name: PolicyGradientAllocationModel,
    DQNRegimeAllocationModel.name: DQNRegimeAllocationModel,
    PPORegimePolicyModel.name: PPORegimePolicyModel,
    TemporalTransformerRegimeModel.name: TemporalTransformerRegimeModel,
    TCNRegimeModel.name: TCNRegimeModel,
    LSTMRegimeModel.name: LSTMRegimeModel,
}
